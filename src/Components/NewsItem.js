    ...
    return (
      <div className='container'  >
       ...
       <p>{this.props.discription}
        <button className="border border-danger rounded " >
          <a href={this.props.rediectUrl} className='link-underline link-underline-opacity-0'   style={{textDecoration: 'none',color:"red"}}>more</a>
       </button>
       </p>
